...
export interface ZTokenInterface extends utils.Interface {
  functions: {
...
export interface ZToken extends BaseContract {
  ...
  callStatic: {
    ...
    initialise(overrides?: CallOverrides): Promise<void>;
